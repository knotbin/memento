...
public func ConfigureModelContainer() -> ModelContainer {
    ...
    let modelConfiguration = ModelConfiguration(schema: schema, isStoredInMemoryOnly: false, groupContainer: .identifier("group.xyz.knotbin.memento.app"), cloudKitDatabase: .none)
